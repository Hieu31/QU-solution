...
def generate_notebook():
    ...
    cells.append({
        ...
        "outputs": [],
        "source": [
            "import argparse, torch, ctranslate2\n",
            "try:\n",
            ...
            "\n",
            "ct2_dirs = {}\n",
            "print(\"\\nConverting checkpoints to CTranslate2 (FP16)...\")\n",
            "\n",
            "for arm in ACTIVE_ARMS:\n",
            "    arm_ckpt_dir = checkpoints_root / arm\n",
            "    ckpts = sorted(list(arm_ckpt_dir.glob('model_step_*.pt')))\n",
            "    if not ckpts:\n",
            "        print(f\"Warning: No checkpoint found for {arm}! Skipping.\")\n",
            "        continue\n",
            "    latest_ckpt = ckpts[-1]\n",
            "    \n",
            ...
            "        print(f\"  Python API conversion warning: {e}. Trying CLI fallback with --unsafe_deserialization...\")\n",
            "        cmd = [\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "        continue\n",
            "    m = eval_matrix[arm]\n",
            "    t_dur = training_results.get(arm, {}).get('duration_sec', 0)\n",
            "    t_min = t_dur / 60\n",
            ...
            "if 'arm_a_2e1d_d128' in eval_matrix and eval_matrix:\n",
