...
CASES: dict[str, list[tuple[str, str]]] = {
    ...
    "location_acronym": [
        ("ltk", "lý thường kiệt"),
        ("đ ltk q1", "đường lý thường kiệt quận 1"),
    ...
    "abbreviation_boundary": [
        ...
        ("đltk q1", "đường lý thường kiệt quận 1"),
    ...
    "telex_malformed": [
        ...
        ("dduwowngf nguyeenx traix", "đường nguyễn trãi"),
        ("saan bay nooji baif", "sân bay nội bài"),
        ("nguyeenxx hueej", "nguyễn huệ"),
        ("thanhf phoos hoof chis minhh", "thành phố hồ chí minh"),
        ("ddiaj chij", "địa chỉ"),
        ("caauf giaays haf nooij", "cầu giấy hà nội"),
    ],
    "vni_and_input_method": [
        ("tru7o7ng2", "trường"),
        ("be65nh5 vie65n6", "bệnh viện"),
        ("d9u7o7ng2 nguye64n tra4i", "đường nguyễn trãi"),
        ("tha2nh pho61 ho62 chi1 minh", "thành phố hồ chí minh"),
        ("ca6u2 gia61y ha2 no65i5", "cầu giấy hà nội"),
        ("sa6n bay no65i5 ba2i", "sân bay nội bài"),
        ("d9ie65n5 bie6n phu3", "điện biên phủ"),
        ("nga4 tu7 so73", "ngã tư sở"),
    ],
    "lexical_typo": [
        ("san bay noi bia", "sân bay nội bài"),
        ("benh vien bach mia", "bệnh viện bạch mai"),
        ("pho ngueyn hue", "phố nguyễn huệ"),
        ("cau giay ah noi", "cầu giấy hà nội"),
        ("ham chui nguyen hune canh", "hầm chui nguyễn hữu cảnh"),
        ("lottee mart", "lotte mart"),
        ("linmart", "winmart"),
        ("ltarbucks", "starbucks"),
    ],
    "number_symbol": [
        ...
        ("sb0137 sao biển 1", "sb01-37 sao biển 1"),
